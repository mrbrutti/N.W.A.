...
func (app *application) routes() (http.Handler, error) {
	...
	mux.HandleFunc("GET /admin", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/users", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/engagements", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/workers", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/connectors", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/audit", app.handleAdminReactRedirect)
	mux.HandleFunc("GET /admin/tools", app.handleAdminReactRedirect)
	mux.HandleFunc("POST /admin/engagements", app.handleAdminEngagements)
	mux.HandleFunc("POST /admin/tools", app.handleAdminTools)
	mux.HandleFunc("/engagements", app.handleEngagementsIndex)
	mux.HandleFunc("/engagements/", app.handleEngagementRouter)
	mux.HandleFunc("GET /api/v1/session", app.handleSessionJSON)
	mux.HandleFunc("POST /api/v1/session/login", app.handleSessionLoginJSON)
	mux.HandleFunc("POST /api/v1/session/logout", app.handleSessionLogoutJSON)
	mux.HandleFunc("GET /api/v1/engagements", app.handleEngagementsJSON)

	mux.HandleFunc("GET /api/v1/admin/overview", app.handleAdminOverviewJSON)
	mux.HandleFunc("GET /api/v1/admin/health", app.handlePlatformHealthJSON)
	mux.HandleFunc("GET /api/v1/admin/users", app.handleAdminUsersJSON)
	mux.HandleFunc("GET /api/v1/admin/engagements", app.handleAdminEngagementsJSON)
	mux.HandleFunc("GET /api/v1/admin/workers", app.handleAdminWorkersJSON)
	mux.HandleFunc("GET /api/v1/admin/connectors", app.handleAdminConnectorsJSON)
	mux.HandleFunc("GET /api/v1/admin/audit", app.handleAdminAuditJSON)
	mux.HandleFunc("/api/v1/admin/tools", app.handleAdminToolsJSON)
	mux.HandleFunc("/api/v1/admin/tools/{toolID}", app.handleAdminToolJSON)

	mux.HandleFunc("GET /api/v1/engagements/{slug}", app.handleEngagementJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/summary", app.handleEngagementSummaryJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/scope", app.handleEngagementScopeJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/zones", app.handleEngagementZonesJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/hosts", app.handleEngagementHostsJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/hosts/{ip}", app.handleEngagementHostDetailJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/ports", app.handleEngagementPortsJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/ports/{protocol}/{port}", app.handleEngagementPortDetailJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/findings", app.handleEngagementFindingsJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/findings/{groupID}", app.handleEngagementFindingDetailJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/sources", app.handleEngagementSourcesJSON)
	mux.HandleFunc("POST /api/v1/engagements/{slug}/sources/import", app.handleEngagementSourceImportJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/runs", app.handleEngagementRunsJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/campaigns", app.handleEngagementCampaignsJSON)
	mux.HandleFunc("POST /api/v1/engagements/{slug}/campaigns/run", app.handleEngagementCampaignActionJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/topology", app.handleEngagementTopologyJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/recommendations", app.handleEngagementRecommendationsJSON)
	mux.HandleFunc("POST /api/v1/engagements/{slug}/recommendations/llm", app.handleEngagementRecommendationLLMJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/settings", app.handleEngagementSettingsJSON)
	mux.HandleFunc("POST /api/v1/engagements/{slug}/settings/members", app.handleEngagementMembershipJSON)
	mux.HandleFunc("POST /api/v1/engagements/{slug}/approvals/{approvalID}/approve", app.handleEngagementApprovalJSON)
	mux.HandleFunc("GET /api/v1/engagements/{slug}/events", app.handleEngagementEventsSSE)
